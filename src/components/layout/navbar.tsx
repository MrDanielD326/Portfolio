      ...
      <div className="container mx-auto px-4 sm:px-6 py-2">
        <div className="flex items-center justify-between">
          <motion.div className="flex items-center gap-2">
            <span className="text-lg sm:text-xl font-serif font-bold gradient-text">
                  ...
                  <div className="flex flex-col space-y-6 mt-12 px-6">
                    {navItems.map((item, index) =>
                      <motion.a
                        ...
                        className={`group flex items-center gap-4 p-3 rounded-xl transition-all duration-300 relative overflow-hidden ${activeSection ===
                      ...
                      >
                        <motion.div
                          ...
                          className={`p-2 rounded-lg transition-all duration-300 ${activeSection ===
                          item.href.substring(1)
            ...
            : <div className="flex items-center space-x-4 md:space-x-6">
                {navItems.map(item =>
                  <a
                    key={item.name}
                    href={item.href}
                    className={`relative flex items-center gap-2 text-sm md:text-sm font-medium transition-colors duration-300 ${activeSection ===
                    item.href.substring(1)
                      ? "text-foreground"
